...
const OrderHistoryListScreen = (props: ScreenProps) => {
  const manager = PurchaseManager(props, true);
  return (
    <ImageBackground
  ...
  return (
              <InquiryEmptyView
                ...
                desc="You haven’t purchased any vehicles yet. Browse our collection and choose the perfect ride for yourself!"
