...
import { JourneyManagerType } from '../../../../Journey/Manager/JourneyManager';
import { MainSearchManagerType } from '../../../Manager/MainSearchManager';
interface Props {
  onClose: () => void;
  title: string;
  manager: MainSearchManagerType;
  setMileage: (minPrice: number | null, maxPrice: number | null) => void;
  minPrice? : number | null,
  maxPrice? : number | null
}
const MileageDropDown = (props: Props) => {
      ...
      <Animated.View
        ...
        <View
          ...
          <View
            ...
            />
            <BorderBtn
              isSelected={minPrice != 0 || maxPrice != 500000}
              btnStyle={{
                ...style.btnStyle,
              }}
              onPress={() => {
                if (props.manager.validateBudget(minPrice, maxPrice)) {
                  animateView(false, () => {
                    dispatch(setTabbarVisibility(true))
                    props.setMileage(minPrice, maxPrice);
                  });
                }
              }}
              title="Apply Filter"
...
export default React.memo(MileageDropDown);
