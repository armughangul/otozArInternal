...
export default function MyInquires() {
        ...
        {!visible ? inquiriesData?.inquiries?.length > 0 ? (
              ...
              <View style={{marginTop: 15}}>
                <View
                  ...
                  <Text
                    ...
                    {inquiriesData?.inquiries?.length} Result{inquiriesData?.inquiries?.length === 1?null:'s'}
                  </Text>
                </View>
              </View>
            }
            ...
            renderItem={({item}) => (
              <TouchableOpacity
                onPress={() => {
                  ...
                  navigation.navigate('SingleInquiryDetail', {inquiry: item});
                }}>
          ...
          <View
            ...
            <Text
              ...
              You haven’t made any vehicle inquiries yet. When you do, they'll
              appear here.
            </Text>
            <TouchableOpacity
